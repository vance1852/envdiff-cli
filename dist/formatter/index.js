...
exports.formatCompareJson = formatCompareJson;
exports.formatCompareTable = formatCompareTable;
exports.formatLintJson = formatLintJson;
exports.formatLintTable = formatLintTable;
/**
 * 格式化比较结果为 JSON 字符串
 * @param result - 比较结果
 ...
 * @returns 格式化后的表格字符串
 */
function formatCompareTable(result) {
    const output = [];
 ...
 * @returns 格式化后的 JSON 字符串
 */
function formatLintJson(result) {
    return JSON.stringify(result, null, 2);
}
/**
 ...
 * @returns 格式化后的表格字符串
 */
function formatLintTable(result) {
    const output = [];
